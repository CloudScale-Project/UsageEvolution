...
public class UsageevolutionSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case UsageevolutionPackage.USAGE_EVOLUTION: {
			...
			if (result == null)
				result = caseEntity(usageEvolution);
			if (result == null)
				result = caseIdentifier(usageEvolution);
			if (result == null)
				result = caseNamedElement(usageEvolution);
			if (result == null)
		...
		case UsageevolutionPackage.USAGE: {
			...
			if (result == null)
				result = caseEntity(usage);
			if (result == null)
				result = caseIdentifier(usage);
			if (result == null)
