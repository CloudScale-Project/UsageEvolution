...
public class WorkParameterEvolutionItemProvider
     ...
     * @generated
     */
    public WorkParameterEvolutionItemProvider(final AdapterFactory adapterFactory) {
     ...
     * @generated
     */
    public List<IItemPropertyDescriptor> getPropertyDescriptorsGen(final Object object) {
    ...
    /**
     * This adds a property descriptor for the Evolution feature. <!-- begin-user-doc --> <!--
     * end-user-doc -->
     *
     * @generated
     */
    protected void addEvolutionPropertyDescriptor(final Object object) {
        this.itemPropertyDescriptors.add
                (this.createItemPropertyDescriptor
                (((ComposeableAdapterFactory) this.adapterFactory).getRootAdapterFactory(),
                        this.getResourceLocator(),
                        this.getString("_UI_WorkParameterEvolution_evolution_feature"),
    ...
    class VariableCharacterisationPropertyDescriptor extends ItemPropertyDescriptor {
        ...
        public VariableCharacterisationPropertyDescriptor(final AdapterFactory adapterFactory,
                ...
                final String displayName, final String description, final EStructuralFeature feature,
                final boolean isSettable,
                final boolean multiLine, final boolean sortChoices, final Object staticImage, final String category,
                ...
                public String getText(final Object object) {
                    if (object instanceof VariableCharacterisation) {
                        ...
                        try {
                            ...
                            return VariableCharacterisationPropertyDescriptor.this.getOrgLabelProvider(object).getText(
                                    object);
                        }
                    }
                    return VariableCharacterisationPropertyDescriptor.this.getOrgLabelProvider(object).getText(object);
                }

                @Override
                public Object getImage(final Object object) {
                    return VariableCharacterisationPropertyDescriptor.this.getOrgLabelProvider(object).getImage(object);
                }
    ...
    @Override
    public Object getImage(final Object object) {
        return this.overlayImage(object, this.getResourceLocator().getImage("full/obj16/WorkParameterEvolution"));
    }
    ...
    @Override
    public String getText(final Object object) {
        return this.getString("_UI_WorkParameterEvolution_type");
    }
