...
/**
 * This is the action bar contributor for the Usageevolution model editor. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class UsageevolutionActionBarContributor
...
implements ISelectionChangedListener {
    ...
    protected IAction showPropertiesViewAction =
            new Action(UsageevolutionEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
        @Override
        public void run() {
            try {
                UsageevolutionActionBarContributor.this.getPage()
    ...
    protected IAction refreshViewerAction =
            new Action(UsageevolutionEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
        @Override
        public boolean isEnabled() {
            return UsageevolutionActionBarContributor.this.activeEditorPart instanceof IViewerProvider;
        }

        @Override
        public void run() {
            if (UsageevolutionActionBarContributor.this.activeEditorPart instanceof IViewerProvider) {
                final Viewer viewer = ((IViewerProvider) UsageevolutionActionBarContributor.this.activeEditorPart)
                                .getViewer();
                if (viewer != null) {
                    viewer.refresh();
                }
     ...
     * @generated
     */
    public UsageevolutionActionBarContributor() {
    ...
    public void contributeToToolBar(final IToolBarManager toolBarManager) {
        toolBarManager.add(new Separator("usageevolution-settings"));
        toolBarManager.add(new Separator("usageevolution-additions"));
    }
    ...
    public void contributeToMenu(final IMenuManager menuManager) {
        ...
        final IMenuManager submenuManager = new MenuManager(
                UsageevolutionEditorPlugin.INSTANCE.getString("_UI_UsageevolutionEditor_menu"),
                "org.scaledl.usageevolutionMenuID");
        ...
        this.createChildMenuManager = new MenuManager(
                UsageevolutionEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        submenuManager.insertBefore("additions", this.createChildMenuManager);

        // Prepare for CreateSibling item addition or removal.
        //
        this.createSiblingMenuManager = new MenuManager(
                UsageevolutionEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
    ...
    public void menuAboutToShow(final IMenuManager menuManager) {
        ...
        submenuManager = new MenuManager(UsageevolutionEditorPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
        this.populateManager(submenuManager, this.createChildActions, null);
        menuManager.insertBefore("edit", submenuManager);

        submenuManager = new MenuManager(UsageevolutionEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
